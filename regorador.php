<?php
	...
	foreach ($data['team'] as $participant) 
	{
		...
		if($idinteresado > 0)
		{
			$sql2 = "INSERT INTO forminteresadosdetalle (idinteresado, nivelestudio, control_insert, tramitedatos, publicidad, urlarchivos, idform, infcookie, GrupoEstudio, idcharla, tipparticipante)
					VALUES ('$idinteresado', '$nivelestudio', now(), '$tramitedatos', '$publicidad', '$urlarchivos', '$idform', '$procedencia','$grupo', '$idcharla', '$tipopart')";	
